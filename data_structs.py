...
class Vocabulary(object):
    ...
    def __init__(self, init_from_file=None, max_length=140):
        ...
        self.special_tokens = ['EOS', 'GO', 'is_NLRP3', 'not_NLRP3',  'high_QED', 'low_QED',
                               'good_SA', 'bad_SA']
...
class MolData(Dataset):
    ...
    def condition_convert(self, con_df):
        ...
        con_df['NLRP3'][con_df['NLRP3'] == 1] = 'is_NLRP3'
        con_df['NLRP3'][con_df['NLRP3'] == 0] = 'not_NLRP3'
