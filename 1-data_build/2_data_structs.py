...
def write_smiles_to_file(smiles_list, nlrp3, fname):
...
def construct_vocabulary(smiles_list):
    ...
    with open('result/Voc_all-0', 'w') as f:
...
if __name__ == "__main__":
    ...
    smiles_list, nlrp3 = canonicalize_smiles_from_file(smiles_file)
    print("Constructing vocabulary...")
    #voc_chars = construct_vocabulary(smiles_list)
    write_smiles_to_file(smiles_list, nlrp3, "")
