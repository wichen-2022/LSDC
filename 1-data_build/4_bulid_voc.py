...
def canonicalize_smiles_from_file(fname):
    """Reads a CSV file with SMILES data and returns a list of canonical SMILES"""
    ...
    return smiles_list,nlrp3,Qed,sascore,RAscore,logP,logS,


def filter_mol(mol, max_heavy_atoms=50, min_heavy_atoms=10, element_list=[6,7,8,9,16,17,35]): # 碳，氮，氧，氟，硫，氯，溴
...
def write_smiles_to_file(smiles_list, nlrp3,Qed, sascore, logP, fname):
    """Write a list of SMILES to a CSV file."""
...
if __name__ == "__main__":
    ...
    smiles_list, nlrp3,Qed,sascore,RAscore,logP,logS, = canonicalize_smiles_from_file(smiles_file)
    print("Constructing vocabulary...")
    voc_chars = construct_vocabulary(smiles_list)
    write_smiles_to_file(smiles_list, nlrp3, Qed,sascore,logP,"")
